...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    <div class="form-width"> 
        ...
        <div class="form-group">
            <asp:Label ID="lbAddress" runat="server" Text="Label">Endereço:</asp:Label>
        ...
        <div class="form-group">
            <asp:Label ID="lbCorporateActivity" runat="server" Text="Label">Atividade Empresarial:</asp:Label>
